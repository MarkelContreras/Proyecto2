...
from graficos_globales import grafico_validos_vs_errores_global, grafico_codigos_error_global, grafico_inputs_por_sesion, grafico_errores_por_sesion, grafico_duracion_sesiones, grafico_radar_programa, grafico_longitud_inputs_global, categorizar_longitud, grafico_ratio_fallos

sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../../")))

from config_db import get_duckdb_connection
...
query = "SELECT * FROM fuzzing_data"
df = duck_con.execute(query).df()
